...
const questions=[
    ...
    {
        question: 'who is called father of computer ? ',
        answers: [
            { text: 'John Williams', correct: false},
            { text: 'charles Henry', correct: false},
            { text: 'charles Babage', correct: true},
            { text: 'charles Wiliam', correct: false}
        ]
    },
    {
        question: 'What is full form of RAM ? ',
        answers: [
            { text: 'Random Allowance Magnetation', correct: false},
            { text: 'Read Available Memory', correct: false},
            { text: 'Rounghly Access Memory', correct: false},
